        ...
        <section>
            ...
            <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="bg-gray-100 p-4 rounded shadow hover:shadow-lg transition">
                        <img src="https://redtape.com/cdn/shop/files/RSO4102_1_c0a68240-77e5-4003-8465-bff2bb2280a7.jpg?v=1741350323" alt="Product" class="w-full h-48 object-cover rounded">
                        <p class="text-lg font-semibold mt-2">Safari Shoes</p>
                        <p class="text-gray-600">$400 <span class="text-red-500 line-through">$450</span></p>
