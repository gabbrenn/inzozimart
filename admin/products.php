...
try {
    ...
    $stmt = $pdo->query("SELECT products.*, categories.category_name FROM products 
                ...
                <table id="productTable" class="w-full text-left">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="p-3"><?= htmlspecialchars($row['price']) ?></td>
                            <td class="p-3"><?= htmlspecialchars($row['stock']) ?></td>
                            <td class="p-3 text-center">
                                <a href="update_product.php?id=<?= $row['id'] ?>" class="text-blue-400 hover:underline">Edit</a>
